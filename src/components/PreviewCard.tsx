		...
		<Card className={`w-[380px] h-[300px] ${showVibrancy ? 'bg-content1  bg-opacity-50' : 'bg-content2'} rounded-2xl`} shadow='none'>
			...
			<CardBody>
				<div className='flex flex-col gap-1 justify-center h-full'>
					...
					{showButton(ipcProps) && <Button disableRipple className='rounded' color='primary' onPress={btn1Handler}>{ipcProps.buttonText}</Button>}
					{showButton2(ipcProps) && <Button disableRipple className='rounded' color='primary' onPress={btn2Handler}>{ipcProps.button2Text}</Button>}
				</div>
			</CardBody>
		</Card>
	);
