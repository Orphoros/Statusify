	...
	return (
		<div>
			...
			<div className='flex gap-6'>
				<MudaContextMenu className='w-full' menuItems={
					() => new MenuOptionBuilder(ctxMenuTranslator, osType)
						.addCopy(ipcProps.buttonText)
						.addCut(ipcProps.buttonText, () => {
				...
				<MudaContextMenu className='w-full' menuItems={
					() => new MenuOptionBuilder(ctxMenuTranslator, osType)
						.addCopy(ipcProps.buttonUrl)
						.addCut(ipcProps.buttonUrl, () => {
			...
			<div className='flex gap-6'>
				<MudaContextMenu className='w-full' menuItems={
					() => new MenuOptionBuilder(ctxMenuTranslator, osType)
						.addCopy(ipcProps.button2Text)
						.addCut(ipcProps.button2Text, () => {
				...
				<MudaContextMenu className='w-full' menuItems={
					() => new MenuOptionBuilder(ctxMenuTranslator, osType)
						.addCopy(ipcProps.button2Url)
						.addCut(ipcProps.button2Url, () => {
