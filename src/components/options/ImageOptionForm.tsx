	...
	return (
		<div>
			...
			<div className='flex gap-6 mb-2'>
				...
				/>
				<Switch className='self-start mt-4' isSelected={ipcProps.largeImageEnabled} isDisabled={ipcProps.idError} onValueChange={
					enabled => {
			...
			<div className='flex gap-6 mb-6'>
				...
				/>
				<div>
					<Switch className='self-start mt-4' isSelected={ipcProps.largeImageTooltipEnabled} isDisabled={ipcProps.idError! || !ipcProps.largeImageEnabled} onValueChange={
						enabled => {
			...
			<div className='flex gap-6 mb-2'>
				...
				/>
				<Switch className='self-start mt-4' isSelected={ipcProps.smallImageEnabled} isDisabled={ipcProps.idError! || !ipcProps.largeImageEnabled} onValueChange={
					enabled => {
			...
			<div className='flex gap-6'>
				...
				/>
				<Switch className='self-start mt-4' isSelected={ipcProps.smallImageTooltipEnabled} isDisabled={ipcProps.idError! || !ipcProps.largeImageEnabled || !ipcProps.smallImageEnabled} onValueChange={
					enabled => {
